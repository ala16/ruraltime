...
export function Atrativos() {
  return <section id="atrativos" className="py-20 bg-accent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
          {atrativos.map(atrativo => <Card key={atrativo.id} className="hover:shadow-xl transition-all duration-300 overflow-hidden group">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  {atrativo.telefone && <div className="flex items-center gap-2">
                      <Phone className="w-4 h-4 text-primary flex-shrink-0" />
                      <a href={`tel:${atrativo.telefone.replace(/\D/g, '')}`} className="text-primary hover:underline font-medium">
                        {atrativo.telefone}
                      </a>
                    </div>}
                  
                  {atrativo.horario && <div className="flex items-center gap-2">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {atrativo.instagram && <Button variant="outline" size="sm" asChild className="hover:bg-primary hover:text-white">
                  ...
                  {atrativo.facebook && <Button variant="outline" size="sm" asChild className="hover:bg-primary hover:text-white">
                  ...
                  {atrativo.site && <Button variant="outline" size="sm" asChild className="hover:bg-secondary hover:text-white">
